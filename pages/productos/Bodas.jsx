...
export async function getStaticProps() {
  const rows = await query('SELECT product_id, name, price, description, size, category_id FROM product WHERE name LIKE "%boda%"'); // Asegúrate de ajustar el ID de la categoría según sea necesario
...
export default function Boda({ products }) {
    return (
        <>
            <Layout
                title="Invitaciones"
                description="Página de invitaciones para bodas"
