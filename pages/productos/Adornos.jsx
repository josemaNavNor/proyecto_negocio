...
export async function getStaticProps() {
  const rows = await query('SELECT product_id, name, price, description, size, category_id FROM product WHERE name LIKE "%adorno%"'); // Asegúrate de ajustar el ID de la categoría según sea necesario
